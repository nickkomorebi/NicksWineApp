...
export function LinkWineSheet({ tripId, open, onClose }: LinkWineSheetProps) {
  ...
  return (
    <>
      ...
      {/* Sheet anchored above the keyboard — results on top, search bar on bottom */}
      <div className="fixed bottom-0 left-0 right-0 z-[70] bg-background rounded-t-2xl shadow-xl flex flex-col-reverse">

        {/* Search bar — at the very bottom, sits just above the keyboard */}
        <div className="px-4 pt-3 pb-20 border-t border-border bg-background rounded-b-none">
        ...
        {/* Results + header — above the search bar, scrollable */}
        <div className="flex flex-col overflow-hidden">
          ...
          {/* Wine list */}
          <div className="overflow-y-auto px-4 pb-3 space-y-2" style={{ maxHeight: "45svh" }}>
            {loading ? (
